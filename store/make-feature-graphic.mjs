...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1024" height="500" viewBox="0 0 1024 500">
  ...
  <g transform="translate(120 122) scale(8)" stroke="${INK}" stroke-width="3">
    <line x1="16" y1="3" x2="16" y2="29"/>
    <rect x="9.5" y="11" width="13" height="10" fill="${BG}"/>
  </g>
  <text x="620" y="235" fill="#f7f7fa" font-family="Arial, Helvetica, sans-serif" font-size="72" font-weight="700" text-anchor="middle">VibeTrading</text>
  <text x="620" y="290" fill="#9aa0ad" font-family="Arial, Helvetica, sans-serif" font-size="28" text-anchor="middle">Levels and patterns, scoped to your chart</text>
</svg>`
